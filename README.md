...
tài liệu retrieve, cổng "có incident KHỚP?", và phần chẩn đoán. Sidebar chỉnh Top-K,
ngưỡng khớp, bật/tắt gọi model. Bộ ví dụ sẵn có:
...
> OpenAI tự cache prefix; trích dẫn nguồn thực hiện qua prompt (nhãn [n]).
